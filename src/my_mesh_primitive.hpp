...
namespace cgp
{
	...
	*/
	mesh my_mesh_primitive_cylinder(float radius=0.2f, vec3 const& p0={0,0,0}, vec3 const& p1={0,0,1}, float radius2=-1, int Nu=10, int Nv=20, bool is_closed=false);
	...
	*/
	...
	mesh my_mesh_primitive_disc(float radius=1.0f, vec3 const& center={0,0,0}, vec3 const& normal={0,0,1}, float radius2=-1, int N=40);
	...
	/**	*/
	mesh my_mesh_primitive_cone(float radius=0.5f, float height=1.0f, vec3 const& center_of_base={0,0,0}, vec3 const& axis_direction={0,0,1}, float radius2=-1, bool is_closed_base=true, int Nu=20, int Nv=10);
