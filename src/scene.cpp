...
void scene_structure::initialize()
{
	...
	// // bec1.initialize_data_on_gpu(my_mesh_primitive_cylinder(0.1f, { 0,0,0 }, { 0,-0.2f,0 }, 0.07f));
	// // bec2.initialize_data_on_gpu(my_mesh_primitive_cone(0.1f, 0.2f, { 0,0,0 }, { 0,-1,0 }, 0.07f));
...
void scene_structure::display_frame()
{
	...
	// hierarchy["Cube base"].transform_local.rotation = rotation_transform::from_axis_angle({ 1,0,0 }, sin(timer.t));
	...
	// hierarchy["Cylinder1 son"].transform_local.rotation = rotation_transform::from_axis_angle({ 0,0,1 }, -10 * timer.t);

	// hierarchy["Wing Right1"].transform_local.rotation = rotation_transform::from_axis_angle({1,0,0},sin(6 * timer.t));
	// hierarchy["Wing Right2"].transform_local.rotation = rotation_transform::from_axis_angle({1,0,0},sin(6 * timer.t));
	// hierarchy["Wing Left1"].transform_local.rotation = rotation_transform::from_axis_angle({1,0,0},sin(-6 * timer.t));
	// hierarchy["Wing Left2"].transform_local.rotation = rotation_transform::from_axis_angle({1,0,0},sin(-6 * timer.t));
	// hierarchy["head1"].transform_local.rotation = rotation_transform::from_axis_angle({0,1,0},sin(2*timer.t)/4);
